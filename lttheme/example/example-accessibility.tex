...
\ExplSyntaxOn
\setltxtalkheadingbehavior{auto-section-title = true}
\ExplSyntaxOff
...
% verwenden, damit jede Folie eine echte Überschrift hat. Mit
% auto-section-title uebernimmt die erste Folie nach \section/\subsection
% deren Text automatisch als Titel, ohne ihn zu wiederholen -- ein leeres
% \frametitle{} genuegt.
