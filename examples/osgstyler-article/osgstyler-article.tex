...
\DeclareOsgColorPalette{editorial}{
  primary    = {HTML}{244A73},
  secondary  = {HTML}{4F6D7A},
  accent     = {HTML}{D97706},
  text       = {HTML}{202428},
  background = {HTML}{FFFDF8},
...
The command \doubleemph{combines simultaneous overlining and underlining},
including across ordinary line breaking when used in a longer passage.

An enclosure and an affix can also be composed:
