...
\option{document\_metadata} (\keyval{enabled}{}/\keyval{disabled}{}) ist eine
...
(\keyval{enabled}{}/\keyval{disabled}{}) is a deliberate output choice and
...
\code{supported}-Profil, wenn \keyval{document\_metadata}{enabled} im Manifest
...
the manifest sets \keyval{document\_metadata}{enabled}. Symbols such as
