...
\begin{description}
  ...
  \item[\cs{IncludeOsgLecturePreamble}\sarg\oarg*{modes}\oarg{class=list}
...
\oarg*{mode}\oarg{short value}\marg{long value}.}{The predefined metadata
...
\oarg*{mode}\oarg{short value}\marg{long value}.}
