...
Dazu ist \cls{osglecture} eine \emph{Metaklasse}: Sie sagt (anders als die mindestens
...
Ti\emph{k}Z-Tutorial inspiriert.}{The idea of presenting a tutorial as a story was inspired by \name{Till Tantau} and his Ti\emph{k}Z tutorial.}}
