...
\ldeen*{@1 ist das Nachfolgeprojekt von @2, das sich aus einem
  ...
  {\osglecture}
{\textcolor{blue}{OSG Beamer}\footnote{\url{https://github.com/tuc-osg/osgbeamer}}}
...
Dazu ist \cls{osglecture.cls} eine \emph{Metaklasse}: Sie sagt (anderes als die mindestens
