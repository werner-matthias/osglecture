...
\begin{itemize}
  ...
  \item \ldeen{
    \OLLM{} ist ein weiteres \LaTeX-Build-Tool, aber speziell auf \osglecture{} zugeschnitten. Es
    ...
    \OLLM{}: yet another \LaTeX build tool that is tailored specifically to \osglecture{}. It works closely with 
