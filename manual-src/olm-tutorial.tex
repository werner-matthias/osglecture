...
\code{en}. The pupular language package \pkg{babel}, by contrast, needs the more specific names
...
\ldeen{Der Befehl \cs{lecture} dient Laura, um eine Unterrichtseinheit zu beginnen.
Das erste Pflichargument ist der Titel, das optionale Argument seine Kurzform.}{}
...
\code{memory}, is the lable of the unit. It constitutes the unit's stable identity.
...
\ldeen{Die \env{frame}-Umgebung kenn Nora schon aus ihrer früheren Arbeit mit \pkg{beamer}. 
  Sie hat dort zwar häufig den Titel in ein Umgebungsargument geschrieben, aber das darf sei bei \osglecture\ nicht,
  dafür gibt es den Befehl \cs{frametitle}.}{}
\ldeen{Den Befehl \cs{ldeen} kennt Nora noch nicht. Sie findet auch bei einem kurzem \File{grep} in ihrem \LaTeX-Verzeichnis kein Paket, das ihn definiert. Jedoch ist Nora iniuitiv klar, was er macht: Er stellt die
beiden Sprachvarianten, die Nora bestellt hat, nebeneinander da.}{}
...
Dann braucht sie für die Langform auch keinen extra Modus: die dortigen Texte werden bei den Präsentationen ignoriert.}{}
