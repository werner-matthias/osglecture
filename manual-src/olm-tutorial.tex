...
würde. Sie legt \texttt{slides-de.tex} an, füllt es mit Inhalt, kopiert die Datei nach
...
Nora legt erst mal eine leere Datei mit dem Namen \texttt{main.tex} an,
...
\texttt{ollm doctor} liefert die passendere Diagnose.}{
