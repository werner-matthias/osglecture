...
\tableofcontents
\endgroup
\captionsetup{font=footnotesize,labelfont=bf,textfont=sf}
...
\osglecture\ versucht die Anwendung dieses Konzept noch ein Stück weit zu erweitern.}{It is a
  ...
  \begin{subcaptiongroup}
    ...
    \begin{minipage}[t]{.8\linewidth}
      \fbox{\includegraphics[page=1,width=\linewidth,
        trim=0mm 198mm 38mm 15mm,clip
      ]{polymorphy-script-de.pdf}}
    \caption{\ldeen*{Ausgabe für @1-Taget}{Version for @1-Taget}{\texttt{script}}}
    \end{minipage}
  \end{subcaptiongroup}
  \captionof{figure}{\ldeen*{Alle Varianten sind aus der Quelle in Abb.~@4 erstellt:
...
\begin{minipage}{\linewidth}
  ...
  \begin{subcaptiongroup}
    ...
    \end{minipage}
  \end{subcaptiongroup}  
  \caption{\ldeen*{Umsetzung von des Codes aus Abbildung @1: Gleiche semantische Auszeichnung, unterschiedliche
