...
\ldeen{Das auch gewöhnlich Autorenauszeichnungen unterschiedlich gestaltet und damit polymorph sein können, ist in \LaTeX\ ein alter Hut. \osglecture\ unterstützt dies aber kompfortable durch spezifische Profile.}{It is well known in \LaTeX\ that text markup can vary and thus be polymorphic. However, \osglecture\ provides convenient support for this through specific profiles.}
...
%Der Name ist vielleicht etwas optimistisch, aber das soll uns hier nicht aufhalten.
