...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{.48\linewidth}
    ...
    \includegraphics[page=1,width=\linewidth]{polymorphy-slides-en-crop.pdf}
  \end{minipage}\hfill
  \begin{minipage}[t]{.48\linewidth}
    \centering\textbf{\texttt{slides}, \texttt{de}}\par\smallskip
    \includegraphics[page=1,width=\linewidth]{polymorphy-slides-de-crop.pdf}
  \end{minipage}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{.48\linewidth}
    ...
    \includegraphics[page=1,width=\linewidth]{polymorphy-script-de-crop.pdf}
  \end{minipage}
