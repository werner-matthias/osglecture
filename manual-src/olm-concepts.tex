...
Abschnitt~\ref{sec:content-command-reference}, Serien und Standalone in
Abschnitt~\ref{sec:series-standalone}, Konfiguration und Profile in
...
serves as a reference. This section introduces the fundamental concepts;
complete interface summaries are located with their respective topics:
content and modes in Section~\ref{sec:content-command-reference}, series and
standalone operation in Section~\ref{sec:series-standalone}, configuration and
profiles in Section~\ref{sec:configuration-reference}, and OLLM in
Section~\ref{sec:ollm-reference}.}
\end{infobox}
...
\ldeen{Im Standalone-Betrieb steht dafür die Klassenoption \option{profile} zur
Verfügung.}{In standalone mode, use the \option{profile} class option instead.}
