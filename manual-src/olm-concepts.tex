...
Abschnitt~\ref{sec:series}, Standalone-Betrieb im Abschnitt~\ref{sec:standalone} Konfiguration und Profile in
Abschnitt~\ref{sec:configuration-reference} sowie OLLM in
Abschnitt~\ref{sec:ollm-reference}.}{}
\end{infobox}
...
\end{description}
% TODO: Spätestens hier müsste documentmetadata.tex angesprochen werden
...
% TODO: Erweiterbarkeit: wie? + warum?, ggf. mit Beispiel (oder kommt das im Konfig-Kapitel)