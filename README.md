...
Whilst in general an up-to-date TeX installation is required, few are
...
<!--  
 ...
 -->
 The following table list versions and compatibility, the TL ...` columns show compatibility with
...
|---|---|---|---|---|---|---|
| osglecture | 0.13.0 | 2026/08/21 | 22 | :x: | :+1: | :+1: |
| osglecture-modes[^1] | 0.4.0 | 2026-08-02 | 2 | :+1: | :+1: | :+1: |
| tagpax | v0.8.5-dev | 2026/07/23 | 2 | :+1: | :+1: | :+1: |
| langselect | v1.0.2 | 2026/08/05 | 1 | :+1: | :+1: | :+1: |
| lttheme | v0.4.2 | 2026/08/10 | 7 | :x: | :x: | :+1: |
| lttheme-tuc-2019 | v0.5.0 | 2026/08/05 | 1 | :x: | :x: | :+1: |
| osgdoc | v0.3.3 | 2026/08/14 | 2 | :+1: | :+1: | :+1: |
| ollm | 0.13.0-dev | n/a | 1 | :x: | :+1: | :+1: |
<!-- END MODULE VERSIONS -->
